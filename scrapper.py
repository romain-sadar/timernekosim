...
char_ids = ["10000098", "10000131", "10000106", "10000120"] 
...
for cid in char_ids:
    ...
    with open(f'characters/{res["name"]}.json', 'w', encoding='utf-8') as f:
...
for wid in weap_ids:
    ...
    with open(f'weapons/{res["name"]}.json', 'w', encoding='utf-8') as f:
        json.dump(res, f, indent=4, ensure_ascii=False)
